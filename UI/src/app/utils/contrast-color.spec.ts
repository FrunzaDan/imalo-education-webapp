...
describe('contrastTextColor', () => {
  it('uses black text on bright fills', () => {
    expect(contrastTextColor('#FFC107')).toBe('#000000');
    expect(contrastTextColor('#CDDC39')).toBe('#000000');
    expect(contrastTextColor('#2196F3')).toBe('#000000');
    expect(contrastTextColor('#ffffff')).toBe('#000000');
  });

  it('uses white text on dark fills', () => {
    expect(contrastTextColor('#4E342E')).toBe('#ffffff');
    expect(contrastTextColor('#1B5E20')).toBe('#ffffff');
    expect(contrastTextColor('#3F51B5')).toBe('#ffffff');
